            ...
            if (bModel != null)
            {
                foreach (ModelMesh mesh in bModel.Meshes)
                {
                    foreach (ModelMeshPart part in mesh.MeshParts)
                    {
                       ...
                       // part.Effect.Parameters["DiffuseColor"].SetValue(new Vector4(0, 0, 0, 0));
                        //BasicEffect e = (BasicEffect)part.Effect;
                            ...
                            part.Effect.Parameters["DiffuseColor"].SetValue(new Vector4(diffuse, 0f));
                            part.Effect.Parameters["Alpha"].SetValue(alpha);
                        
                            //alla meshar får samma färg
